...
RECOVERY_VERSION := $(RECOVERY_NAME) v5.5.0.4(1.1)
...
ifneq ($(BOARD_USES_RECOVERY_CHARGEMODE),)
LOCAL_CFLAGS += -DBOARD_USES_RECOVERY_CHARGEMODE=$(BOARD_USES_RECOVERY_CHARGEMODE)
endif

BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_UMS_2ND_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY BOARD_HAS_SDCARD_INTERNAL
